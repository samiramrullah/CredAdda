...
import { QA, CA, US } from 'country-flag-icons/react/3x2';
const Postcard = () => {
                ...
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-3 md:grid-cols-2">
                    <div>
                        <div class="relative w-full h-56">
                            {sendingCountry === '1' && <CA title="CANADA"
                                class="object-cover w-full h-full " />}
                            {sendingCountry === '2' && <QA title="QATAR"
                                class="object-cover w-full h-full " />}
                            {sendingCountry === '3' && <US title="USA"
                                class="object-cover w-full h-full " />}
                        ...
                        <div class="p-4 bg-white dark:bg-gray-700">
                            <DropdownCustom setSendingCountry={setSendingCountry} setRecivingCountry={setRecivingCountry} />
                        </div>
                    </div>
                    <div>
                        {/* <div class="relative w-full h-56">

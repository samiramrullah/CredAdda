                        ...
                        <ul class="mt-8 space-y-2 tracking-wide">
                            ...
                            <li>
                                ...
                                >
                                    ...
                                    <span class="group-hover:text-gray-700 dark:group-hover:text-gray-50">Post</span>
                                </Link>
                            </li>
                            <li>
                                <Link
                                ...
                                >
                                    ...
                                    <span class="group-hover:text-gray-700 dark:group-hover:text-gray-50">All Post</span>
                                </Link>
                            </li>
                            <li>
                                <Link
                                ...
                                >
                                    ...
                                    <span class="group-hover:text-gray-700 dark:group-hover:text-gray-50">Completed</span>
                                </Link>
                            </li>
                            <li>
                                <Link
                                ...
                                >
                                    ...
                                    <span class="group-hover:text-gray-700 dark:group-hover:text-white">Home</span>
                                </Link>
                            </li>
                        </ul>
                    </div>
